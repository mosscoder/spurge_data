...
with open('./results/best_epoch_cutmix.json', 'r') as file:
...
full_dataset = CutMix(full_dataset, num_class=2, beta=cutmix_beta, prob=cutmix_prob, num_mix=cutmix_num_mix)
...
result_path = os.path.join(test_perf_dir, 'cutmix.json')
